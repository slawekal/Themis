...
namespace Themis
{
	...
	/// </summary>
	internal partial class ThemisCommandSet : ThemisCommandSetBase
	{
		/// <summary>
		/// Constructs a new ThemisCommandSet.
		/// </summary>
		public ThemisCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ThemisCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ThemisCommandSetBase.
		/// </summary>
		protected ThemisCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewThemisExplorerCommand,
				typeof(ThemisEditorFactory).GUID);
		...
		{
			ThemisExplorerToolWindow explorer = this.ThemisExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ThemisDocData CurrentThemisDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ThemisDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ThemisDocView CurrentThemisDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ThemisDocView;
			}
		}
		...
		/// </summary>
		protected ThemisExplorerToolWindow ThemisExplorerToolWindow
		{
			get
			{
				ThemisExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ThemisExplorerToolWindow), true) as ThemisExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ThemisExplorerToolWindow explorerWindow = this.ThemisExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ThemisClipboardCommandSet : ThemisClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ThemisClipboardCommandSet.
		/// </summary>
		public ThemisClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ThemisClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ThemisClipboardCommandSetBase.
		/// </summary>
		protected ThemisClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
