...
namespace Themis
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.ThemisEditorFactoryId)]
	internal partial class ThemisEditorFactory : ThemisEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new ThemisEditorFactory.
		/// </summary>
		public ThemisEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ThemisEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected ThemisEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new ThemisDocData(this.ServiceProvider, typeof(ThemisEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new ThemisDocView(docData, this.ServiceProvider);
		}
	}
}
