...
namespace Themis
{
	...
	[VSShell::ProvideToolWindow(typeof(ThemisExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	[VSShell::ProvideToolWindowVisibility(typeof(ThemisExplorerToolWindow), Constants.ThemisEditorFactoryId)]
	[VSShell::ProvideStaticToolboxGroup("@ThemisToolboxTab;Themis.Dsl.dll", "Themis.ThemisToolboxTab")]
	[VSShell::ProvideStaticToolboxItem("Themis.ThemisToolboxTab",
					"@ObjectToolboxItem;Themis.Dsl.dll", 
					"Themis.ObjectToolboxItem", 
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"Themis", typeof(ThemisEditorFactory))]

	internal abstract partial class ThemisPackageBase : DslShell::ModelingPackage
	{
		protected global::Themis.ThemisToolboxHelper toolboxHelper;	
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new ThemisEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Themis.ThemisToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			ThemisCommandSet commandSet = new ThemisCommandSet(this);
			commandSet.Initialize();
			
			// Create the command set that handles cut/copy/paste commands provided by this package.
			ThemisClipboardCommandSet clipboardCommandSet = new ThemisClipboardCommandSet(this);
			clipboardCommandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(ThemisExplorerToolWindow));
...
namespace Themis
{
	...
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::Themis.ThemisDirectiveProcessor), global::Themis.ThemisDirectiveProcessor.ThemisDirectiveProcessorName, "A directive processor that provides access to Themis files")]
	[global::System.Runtime.InteropServices.Guid(Constants.ThemisPackageId)]
	internal sealed partial class ThemisPackage : ThemisPackageBase
	{
	}
}