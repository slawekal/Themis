...
namespace Themis
{
	...
	/// </summary>
	internal partial class ThemisDocView : ThemisDocViewBase
	{
		/// <summary>
		/// Constructs a new ThemisDocView.
		/// </summary>
		public ThemisDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ThemisDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ThemisDocView.
		/// </summary>
		protected ThemisDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ThemisDocDataBase docData = this.DocData as ThemisDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ThemisDocViewBase should be an ThemisDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Themis.Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Themis.Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Themis.ThemisToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Themis.ThemisToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ThemisDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Themis.ThemisHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Themis.ThemisHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Themis.ThemisHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
