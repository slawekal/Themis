...
namespace Themis
{
	...
	/// </summary>
	public static partial class SourceObjectElementReferencesTargetObjectElementBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Themis.ObjectElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Themis.ObjectElement)
				{
					if (candidateTarget is global::Themis.ObjectElement)
					{
						global::Themis.ObjectElement sourceObjectElement = (global::Themis.ObjectElement)candidateSource;
						global::Themis.ObjectElement targetObjectElement = (global::Themis.ObjectElement)candidateTarget;
						if(targetObjectElement == null || global::Themis.SourceObjectElementReferencesTargetObjectElement.GetLinkToSource(targetObjectElement) != null) return false;
						if(sourceObjectElement == null || global::Themis.SourceObjectElementReferencesTargetObjectElement.GetLinkToTarget(sourceObjectElement) != null) return false;
						if(targetObjectElement == null || sourceObjectElement == null || global::Themis.SourceObjectElementReferencesTargetObjectElement.GetLinks(sourceObjectElement, targetObjectElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Themis.ObjectElement)
				{
					if (target is global::Themis.ObjectElement)
					{
						global::Themis.ObjectElement sourceAccepted = (global::Themis.ObjectElement)source;
						global::Themis.ObjectElement targetAccepted = (global::Themis.ObjectElement)target;
						DslModeling::ElementLink result = new global::Themis.SourceObjectElementReferencesTargetObjectElement(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class MappingConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new MappingConnectAction for the given Diagram.
		/// </summary>
		public MappingConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the MappingConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new MappingConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class MappingConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the MappingConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected MappingConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder SourceObjectElementReferencesTargetObjectElementBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return SourceObjectElementReferencesTargetObjectElementBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return SourceObjectElementReferencesTargetObjectElementBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				SourceObjectElementReferencesTargetObjectElementBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class MappingConnectionType : MappingConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the MappingConnectionType with the given ConnectionBuilder.
			/// </summary>
			public MappingConnectionType() : base() {}
		}
	}
}
