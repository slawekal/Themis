...
namespace Themis
{
	...
	/// </remarks>
	public partial class ThemisHelpKeywordHelper : ThemisHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ThemisHelpKeywordHelper.
		/// </summary>
		protected ThemisHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ThemisHelpKeywordHelper.
		/// </summary>
		public static ThemisHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ThemisHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ThemisHelpKeywordHelperBase.
		/// </summary>
		protected ThemisHelpKeywordHelperBase()
			: base() { }
